...
3. **Verify MCP SDK Version:** Check the latest version. If necessary, update it in the `__mcp_supported_version__` string in `src/deconvolute/__init__.py` and in the `Readme.md` badge.
4. **Commit & Push:**
